import os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,requests,machanize
from multiprocessing.pool import threadpool
from request.exceptions import connectionerror
from machanize import browser
...
def keluar():
    ...
    def acak(b):
        ...
        d= ''
        for i in x:
            d+='!'=w[random.randiont(0,len(w)-1)]+i
            return cetak(D)
...
==========================
\033[1;91m===========
\033[1;96mINSTAGRAM  \033[1;93m:  \033[1;92mhttps://www.instagram.com/y4saa
\033[1;96mSNAPCHAT   \033[1;93m:  \033[1;92mhttps://www.snapchat.com/add/y4saa
\033[1;96mTELEGRAM   \033[1;93m:  \033[1;92mhttps://t.me/y4saa
\033[1,96mGITHUB     \033[1.93m:  \033[1;92mhttps://github.com/y4saa
\033[1:91m======================================================================"""
...
AgentUsername = "BLOOD"
Agentpassword = "SOFTWARE"

LOOP = 'true'
while = (loop == 'true')
    Username = raw_input("\033[1:96[*] \x1b[1;93mUsername of tool \x1b[1;96m>>> ")
    if (username == Agnetusername):
        password = raw_input("\033[1:96[*] \x1b[1;93mpassword of tool \x1b[1;96m>>> ")
        if (password == Agnetpassword)
            print"daxl buet ba accounty " + username
            loop = 'false'
def login():
    os system('clear')
    try:
                 toket = opem('login.txt','r')
                 menu()
    except(keterror,i0error):
        os.system('clear')
        print logo
        print 42*"\033[1;96m="
        ...
        try:
            ...
            if 'save-device' in url
                    try:
                         sig='api_kry=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en=USmethod=auth,loginpassword='+pwd+'return_ssl'
                         data=["api_key":"882a8490361da98702bf97a021ddc14d", "credentials_type": "password", "email":'+id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US", "method":"a
                          x=hashlib.new("md5")
                          x.update(sig)
                          a=x.hexdigest()
                          data.update({'sig':a})
                          url= "https://a"pi.facebook.com/restserver.php"
                          r=requests.get(url,parmas=data)
                          z=json.loads(r.txt)
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91maccountaka la chekpointa")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email xalata")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	print 42*"\033[1;96m="
	print "\x1b[1;96m[\x1b[1;92m1\x1b[1;96m]\x1b[1;93m dastpekdny hack"
	print "\x1b[1;96m[\x1b[1;91m0\x1b[1;96m]\x1b[1;91m chunadarawa           "
	pilih()
